...
description: >
  ...
  明确指定相机镜头并要求圆形正面图案、徽章或浮雕时，即使没有写出“镜头盖”，
  也属于本 Skill；光学设计、维修和普通产品照片不属于此路由。
metadata:
...
如果用户明确指定了一颗相机镜头，并要求其圆形正面图案、徽章、浮雕、
卡合盖或 3MF，即使没有写出“镜头盖”四个字，也按本 Skill 路由。只有
光学设计、镜头维修或没有盖体／正面交付物的普通产品照片不适用这一语义快捷规则。
